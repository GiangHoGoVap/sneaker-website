...
<body>
    ...
    if (isset($_POST['submitAddItem'])) {
        ...
        # $sql->execute();
        $sql = pg_query_params($conn, 'INSERT INTO products (product_name, product_image1, product_image2, product_type, product_origin, product_gender, product_description, product_price) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)', array($productName, $productImage_1, $productImage_2, $productType, $productOrigin, $productGender, $productDesc, $productPrice));
